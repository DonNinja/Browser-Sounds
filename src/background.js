...
// const BSDB = getFileStorage({ name: "BrowserSounds", persistent: true });
...
const BSDBOpenRequest = indexedDB.open("BrowserSounds");

BSDBOpenRequest.onerror = (e) => {
	console.error(`Error loading database`);
}

BSDBOpenRequest.onsuccess = (e) => {
	console.log(`Database loaded`);
}

BSDBOpenRequest.onupgradeneeded = (e) => {
	db = e.target.result;
	...
	const objectStore = db.createObjectStore('Sounds', { keypath: 'Audio' });
